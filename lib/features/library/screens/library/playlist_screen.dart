...
class PlaylistScreen extends StatefulWidget {
  ...
  const PlaylistScreen({super.key, required this.initialIndex, required this.playlists});
...
class _PlaylistScreenState extends State<PlaylistScreen> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      children: [
                        ...
                        _buildActionIcons(context, index, playlist),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Row(
                          children: [
                            Text('Playlist · ${formatReleaseDate(playlist['releaseDate'])}', style: TextStyle(fontSize: 14)),
  ...
  Widget _buildActionIcons(BuildContext context, int index, Map<String, dynamic> playlist) {
    return Padding(
      ...
      child: Row(
        children: [
          IconButton(
            ...
            onPressed: () {
              showPlaylistBottomDialog(context, widget.playlists, index);
            },
          ),
          const Spacer(),
          IconButton(
            icon: Icon(
              Bootstrap.shuffle,
              color: isShuffleActive ? AppColors.primary : AppColors.steelGrey,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Playlist suggestion #${index + 1}', style: TextStyle(fontSize: AppSizes.fontSizeMd, fontWeight: FontWeight.bold)),
