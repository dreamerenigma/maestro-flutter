...
import '../../screens/library/playlist_screen.dart';

class LikesList extends StatelessWidget {
  final int initialIndex;

  const LikesList({super.key, required this.initialIndex});
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              createPageRoute(PlaylistScreen(playlists: [], initialIndex: initialIndex)),
                            );
                          },
