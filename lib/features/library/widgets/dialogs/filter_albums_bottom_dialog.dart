...
RxString selectedFilterOption = RxString(storage.read('selectedFilterOption') ?? 'allAlbums');
RxString selectedSortByOption = RxString(storage.read('selectedSortByOption') ?? 'recentlyAdded');

void showFilterAlbumsDialog(BuildContext context) {
      ...
      return Column(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              FilterOption(text: 'All albums'),
              FilterOption(text: 'Owned albums'),
              FilterOption(text: 'Liked albums'),
            ],
          ),
