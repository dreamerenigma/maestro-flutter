              ...
              child: Stack(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text('Clear recently played', style: TextStyle(fontSize: AppSizes.fontSizeBg)),
                      const SizedBox(height: 20),
                      const Text('Are you sure you want to clear your recently played? You won\'t be able to undo this action.'),
                      const SizedBox(height: 20),
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child: const Text('Clear', style: TextStyle(color: AppColors.red, fontWeight: FontWeight.bold, fontSize: 17)),
                          ),
                        ],
                      ),
                    ],
