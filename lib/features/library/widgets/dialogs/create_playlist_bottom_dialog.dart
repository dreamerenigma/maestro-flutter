        ...
        builder: (BuildContext context, setState) {
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Text('Create playlist', style: TextStyle(fontSize: AppSizes.fontSizeBg, fontWeight: FontWeight.bold)),
                      ),
                    ),
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        log('Creating playlist with title: $playlistTitle, public: $playlistPublic');

                        var result = await sl<PlaylistFirebaseService>().createPlaylist(playlistTitle, playlistPublic);
              ...
              _buildTextField('Playlist title', controller, maxLength: 50, currentLength: currentLength, setState: setState),
              Container(
...
Widget _buildTextField(String label, TextEditingController controller, {required int maxLength, required int currentLength, required Function setState}) {
  return Padding(
