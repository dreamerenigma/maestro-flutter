    ...
    return Scaffold(
      body: Column(
        ...
        children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(AppImages.artistBg),
                              fit: BoxFit.cover,
                            ),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage(AppImages.artist),
                                fit: BoxFit.cover,
                              ),
                              borderRadius: BorderRadius.circular(8),
                            ),
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Text('Unlock artist tools & unlimited uploads.', style: TextStyle(fontSize: AppSizes.fontSizeXxl, fontWeight: FontWeight.bold, height: 1, letterSpacing: -1.5)),
          ),
          SizedBox(height: 12),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Text('For 10 850,00 ₽, billed yearly', style: TextStyle(fontSize: AppSizes.fontSizeMd, fontWeight: FontWeight.w400, fontFamily: 'Roboto'), textAlign: TextAlign.left),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: RichText(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, createPageRoute(SeeAllPlansScreen()));
                  },
